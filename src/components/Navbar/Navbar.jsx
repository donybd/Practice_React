...
export default function Navbar({ onSearchChange }) {
  ...
  return (
    <nav className="grid grid-cols-3 justify-between px-24 py-4 bg-[#1A1A2E] items-center">
      <ul>
      ...
      <ul className="flex justify-center items-center">
        ...
        <li className="w-full ">
          <input type="text" className="text-black px-4 py-2 w-full rounded-full focus:ring-2 focus:ring-[#6173E6] focus:outline-none" name="search" id={inputId} placeholder="Search product..." onChange={handleSearchInput} />
        </li>
      </ul>
      {!isLoggedIn ? (
