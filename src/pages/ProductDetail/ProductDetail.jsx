...
export default function ProductDetail() {
  ...
  return (
    <>
      <Navbar></Navbar>
      <div className="flex my-5 px-24 py-4 gap-[30px] items-center">
        <Link to="/">
          <FontAwesomeIcon icon={faArrowLeftLong} className="mb-0 text-[24px]" />
        </Link>
        <h4 className="text-[28px] font-medium">Detail Product</h4>
      </div>
      <div className="flex gap-[30px] px-24">
        <div className="">
          ...
          <img src={product.imageUrl ?? product.name ?? "No Name"} alt={product.name ?? "No Name"} className="block w-[700px] h-[450px] object-cover hover:scale-105 transition-transform duration-300" />
        </div>
        <div className="flex flex-col gap-[10px] mt-5">
          ...
          {product.stock > 0 ? (
            <div>
              <Button type="button" className="inline-flex items-center justify-center rounded-lg gap-2 p-4 bg-[#6173E6] text-center hover:scale-105 transition-transform duration-300 ">
            ...
            <div>
              <Button type="button" className="inline-flex items-center justify-center rounded-lg gap-2 p-4 bg-[#64748b] text-center hover:scale-105 transition-transform duration-300 ">
                <FontAwesomeIcon icon={faCartShopping} className="mb-0 text-white" />
